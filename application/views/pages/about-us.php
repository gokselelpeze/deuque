...
<div class="container mt-5">
    <div class="row py-3">
        ...
        <div class="col-sm-4">
            <div class="card">
                <img class="card-img-top" src="<?php echo base_url()?>assets/img/ibrahim.jpg" alt="Card image" style="width:100%">
                <div class="card-body">
                    ...
                    <ul class="social-network social-circle">
                        ...
                        <li><a href="https://www.linkedin.com/in/çağırkan/" target="_blank" class="icoLinkedin" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
